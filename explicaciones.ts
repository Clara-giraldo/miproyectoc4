...
// import { modeloProyecto } from "./models/proyecto/proyectos";
// import {ObjectId} from 'mongoose';
// import { modeloObjetivo } from "./models/objetivos";
...
//       const objetivoGeneral = await modeloObjetivo.create({
//           descripcion: 'Objetivo general',
//           tipo: Enum_TipoObjetivo.GENERAL,
//           proyecto: proyectoCreado._id,
//       });

//       const objetivoEspecifico1 = await modeloObjetivo.create({
//         descripcion: 'Objetivo Especifico 1',
//         tipo: Enum_TipoObjetivo.ESPECIFICO,
//         proyecto: proyectoCreado._id,
//     });
//     const objetivoEspecifico2 = await modeloObjetivo.create({
//         descripcion: 'Objetivo Especifico 1',
//         tipo: Enum_TipoObjetivo.ESPECIFICO,
//         proyecto: proyectoCreado._id,
//     });
...
//     const proyecto = await modeloProyecto.findOne({_id:'6199bd25ff6d15be803d31a5'});

// console.log('el proyecto encontrado es: ', proyecto);

// const objetivos = await modeloObjetivo.find({project: '6199bd25ff6d15be803d31a5'})
...
//     const proyecto = await modeloProyecto.find({id: '619ad355870cb99b7e268b07'}).populate('objetivos');
...
//     const proyectoCreado = await modeloProyecto.find({id: '619ae5d598d3b14530b48987'});
